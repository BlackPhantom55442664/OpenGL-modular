...
Light::Light() {
	...
	shaderPack.push_back(std::make_pair("LightVertexShader.glsl", GL_VERTEX_SHADER));
	shaderPack.push_back(std::make_pair("LightFragmentShader.glsl", GL_FRAGMENT_SHADER)); 
